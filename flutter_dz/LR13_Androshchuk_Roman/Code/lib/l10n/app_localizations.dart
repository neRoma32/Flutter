...
abstract class AppLocalizations {
  ...
  /// Subtitle or description to select language
  ///
  /// In en, this message translates to:
  /// **'Select Language'**
  String get selectLanguage;

  /// Label displaying the list of available languages
  ///
  /// In en, this message translates to:
  /// **'Available Languages:'**
  ...
  /// Total sum price label
  ///
  /// In en, this message translates to:
  /// **'Total: {price}'**
  String totalPrice(String price);

  /// Formatted date the product was added
  ///
  /// In en, this message translates to:
  /// **'Added: {date}'**
  ...
  /// In en, this message translates to:
  /// **'Jacket'**
  String get productJacket;

  /// Snackbar notification message when language is changed
  ///
  /// In en, this message translates to:
  /// **'Language changed to {language}'**
  String languageChanged(String language);

  /// Placeholder when the product list is empty
  ///
  /// In en, this message translates to:
  /// **'No products yet'**
