...
class Transaction {
  ...
  final dt = date.toString().substring(0, 19);

  return '[$typeStr] ${amount.toStringAsFixed(1)} грн - $dt';
}
}
...
class BankAccount {
  ...
  void deposit(double amount) {
   ...
   print('Додано ${amount.toStringAsFixed(1)} грн. Баланс: ${_balance.toStringAsFixed(1)} грн');
  }
  ...
  void withdraw(double amount) {
    ...
    _transactions.add(
      ...
      print('Знято ${amount.toStringAsFixed(1)} грн. Баланс: ${_balance.toStringAsFixed(1)} грн');
  }
}
...
void printStatistics(BankAccount account) {
  ...
  print('Великі транзакції (>1000 грн): ${filterByAmount(account.transactions, 1000.0).length}',);
  print('Загальна сума депозитів: ${stats.totalDeposits.toStringAsFixed(1)} грн',);
  print('Загальна сума знять: ${stats.totalWithdrawals.toStringAsFixed(1)} грн',);
